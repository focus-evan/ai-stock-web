import type { NorthboundData, NorthboundStock } from "#src/api/strategy/types";
...
const NorthboundPage: React.FC = () => {
	...
	const fetchData = async () => {
		...
		setError(null);
		try {
			const response = await fetchNorthboundRecommendations(13);
	...
	const columns: ColumnsType<NorthboundStock> = [
		{
			title: "排名",
			dataIndex: "rank",
			key: "rank",
